...
set_property -dict {PACKAGE_PIN AB11 IOSTANDARD DIFF_SSTL15} [get_ports o_ddr3_clk_p]
set_property -dict {PACKAGE_PIN AC11 IOSTANDARD DIFF_SSTL15} [get_ports o_ddr3_clk_n]
...
set_property -dict {PACKAGE_PIN Y8   IOSTANDARD SSTL15} [get_ports o_ddr3_s_n[0]]
set_property -dict {PACKAGE_PIN V7   IOSTANDARD SSTL15} [get_ports o_ddr3_s_n[1]]
